    ...
    <div className="w-full relative">
      ...
      <section className="py-24 bg-brand-muted">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-display font-bold text-brand-primary mb-12">Search by Topic</h2>
          <div className="flex flex-wrap justify-center gap-4">
            {["Market Outlook", "Retirement Planning", "Tax Strategies", "Real Estate", "Crypto & Web3", "Personal Budgeting", "Business Financing"].map((topic, i) => (
              <span key={i} className="px-6 py-3 rounded-full bg-white border border-brand-primary/10 text-brand-primary font-medium hover:bg-brand-primary hover:text-white transition-colors cursor-pointer shadow-sm">
                {topic}
              </span>
            ))}
          </div>
