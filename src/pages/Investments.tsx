    ...
    <div className="w-full relative">
      ...
      <section className="py-24 bg-brand-light text-center">
        <div className="max-w-3xl mx-auto px-4">
          <h2 className="text-3xl md:text-5xl font-display font-bold text-brand-primary mb-6">Investment Portfolios</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
            <div className="bg-white rounded-3xl p-8 border border-brand-primary/10 shadow-sm">
              <h3 className="text-2xl font-bold text-brand-primary mb-2">Automated Investing</h3>
            ...
            <div className="bg-brand-secondary rounded-3xl p-8 border border-transparent shadow-md text-white">
              ...
              <button className="w-full py-3 rounded-xl bg-brand-accent text-brand-primary font-bold hover:bg-brand-accent/90 transition-colors">Open Brokerage</button>
            </div>
          </div>
        </div>
      </section>
